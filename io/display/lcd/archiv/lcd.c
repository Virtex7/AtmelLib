...
#else
	LCD_DDR|=(1<<LCD_D4_PIN)|(1<<(LCD_D4_PIN+1))|(1<<(LCD_D4_PIN+2))|(1<<(LCD_D4_PIN+3))|(1<<LCD_RS_PIN)|(1<<LCD_EN_PIN);
...
@param mode LCD_CURSOR_OFF, LCD_CURSOR_ON, LCD_BLINK or LCD_CURSOR_AND_BLINK
